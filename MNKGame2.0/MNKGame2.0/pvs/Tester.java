...
public class Tester {
	...
	protected static void configurationTest(int m, int n, int k) {
		...
		mnkgame.MNKPlayerTester.main(
				new String[] { "-r", "2", valueOfM, valueOfN, valueOfK, "pvs.AiPvs", "mnkgame.QuasiRandomPlayer", "-v" });
		mnkgame.MNKPlayerTester.main(
				new String[] { "-r", "2", valueOfM, valueOfN, valueOfK, "mnkgame.QuasiRandomPlayer", "pvs.AiPvs","-v" });
	}
